...
* Атрибуты `width`, `height` и `viewbox` в `<svg>`
...
<p data-height="450" data-theme-id="dark" data-slug-hash="VKJMMY" data-default-tab="result" data-user="FMRobot" data-embed-version="2" data-pen-title="VKJMMY" class="codepen"><a href="http://codepen.io/FMRobot/pen/VKJMMY/">Посмотрите на CodePen</a>.</p>
...
В том, что делает Firefox есть смысл, но это означает, что медиа-запросы привязаны к пикселям.
